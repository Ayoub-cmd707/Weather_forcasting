...
class EUPPFullEnsembleDataset(Dataset):
    def __init__(self, nsample, target_var,data_path="data",num_ensemble=11, dataset_type="train", normalized=True, return_time=False):
        ...
        self.value_range = {"t2m":(235, 304), "z": (48200, 58000), "t":(240, 299), "u10": (-13., 11.),"v10": (-30,35), "tcc": (0., 1.0),"sd":(0,8),"mx2t6":(230,320),"mn2t6":(225,315),"v":(-50,55), "w100":(0,50),"w10":(0,30), "u100": (-35,45), "u": (-45,60),"v100":(-40,45), "w700": (0,60), "p10fg6": (0,60), "oro":(-400,2800), "ssrd6":(0,30000000), "ssrd6_obs": (0, 30000000), "strd6":(1,10000000) }
